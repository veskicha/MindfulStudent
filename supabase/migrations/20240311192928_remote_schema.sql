...
ALTER TABLE "public"."reactions" ALTER COLUMN "messageId" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."reactions_messageId_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "public_messages_from_id_fkey" FOREIGN KEY ("from_id") REFERENCES "public"."profiles"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "public_messages_to_id_fkey" FOREIGN KEY ("to_id") REFERENCES "public"."profiles"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE ON TABLE "public"."profiles" TO "anon";
...
GRANT ALL ON SEQUENCE "public"."reactions_messageId_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."reactions_messageId_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."reactions_messageId_seq" TO "service_role";
